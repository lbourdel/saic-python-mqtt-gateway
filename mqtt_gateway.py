...
class VehicleHandler:
    ...
    def update_charge_status(self) -> OtaChrgMangDataResp:
        ...
        self.publisher.publish_int(f'{self.vehicle_prefix}/bms/bmsChrgCtrlDspCmd', charge_mgmt_data.bmsChrgCtrlDspCmd)
        self.publisher.publish_int(f'{self.vehicle_prefix}/bms/bmsChrgOtptCrntReq', charge_mgmt_data.bmsChrgOtptCrntReq)
        self.publisher.publish_int(f'{self.vehicle_prefix}/bms/bmsChrgSts', charge_mgmt_data.bmsChrgSts)
        self.publisher.publish_int(f'{self.vehicle_prefix}/bms/bmsPackVol', charge_mgmt_data.bmsPackVol)
        self.publisher.publish_int(f'{self.vehicle_prefix}/bms/bmsPTCHeatReqDspCmd',
